...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class PlayServicesAuthLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with versionRef 'playServicesAuth'.
            ...
            /**
             * Creates a dependency provider for v2101 (com.google.android.gms:play-services-auth)
         * with versionRef 'playServicesAuthVersion'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getV2101() {
                return create("play.services.auth.v2101");
        }
    ...
    public static class RuntimeLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'runtimeAndroid'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: playServicesAuthVersion (21.0.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
